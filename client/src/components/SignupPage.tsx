...
interface SignupPageProps {
  onBackClick: () => void
  onSignupSuccess: (token: string, username: string, email: string) => void
}
...
export function SignupPage({ onBackClick, onSignupSuccess }: SignupPageProps) {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.token) {
        ...
        onSignupSuccess(data.token, data.username, data.email);
      } else {
      ...
      >
        ...
        <div className="hidden md:block w-1/2 h-[600px] relative overflow-hidden border-r border-[#1f2130]">
          <div className="absolute inset-0 bg-gradient-to-br from-[#0f1120] to-[#151929]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 z-10">
              ...
              >
                Join us to compare AI responses and find the best answers
              </motion.p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
          ...
          >
            ...
            <p className="text-gray-400 mb-8">Start comparing AI responses today</p>
            ...
            <form className="space-y-4" onSubmit={handleSignup}>
              ...
              >
                <button
                  ...
                  disabled={loading}
                  className={cn(
                    "w-full bg-gradient-to-r relative overflow-hidden from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 disabled:opacity-50 text-white py-2 rounded-lg transition-all duration-300",
